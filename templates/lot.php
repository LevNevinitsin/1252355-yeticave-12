            ...
            <div class="lot-item__state">
                ...
                <div class="lot-item__cost-state">
                    ...
                    <div class="lot-item__min-cost">
                        Мин. ставка <span><?= esc(formatPrice($item['current_price'] + $item['item_bid_step']))?></span>
                    </div>
                </div>
                <form class="lot-item__form" action="https://echo.htmlacademy.ru" method="post" autocomplete="off" style="display: none;">
